...
x3 = input('For X3:  ');
y3 = input('And for Y3:  ');
fprintf('Points: (%.f,%.f), (%.f,%.f) and (%.f,%.f). \n', x1,y1,x2,y2,x3,y3)
...
fprintf('Given 3 points, the circle formed has its at center (%.f,%.f) with radius of %.f units. \n', h,k,r)
fprintf('The vector would be: V[%.f,%.f,%.f].',D,E,F)